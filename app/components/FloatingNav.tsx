    ...
    <>
      ...
      <div className="fixed bottom-6 left-6 z-50 flex gap-3">
        <button
          ...
          className="w-10 h-10 bg-black/50 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-black/75 transition-all shadow-lg hover:scale-105 active:scale-95 cursor-pointer"
        >
          {isOpen ? (
